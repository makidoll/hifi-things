...
function updateUserLocal(id) {
	...
	if (nametag == undefined) {
		...
		addNametag(id, {
			...
			avatarURL:
				"https://metaverse.highfidelity.com/assets/users/hero-default-user-d5a4727d1ad1fb9d9cd26383e26e2697dfd9f4d2f3f81da86c4990771ca8810d.png",
			connection: null,
			admin: false,
		});
	} else {
