declare namespace Controller {
	...
	// signals
	const actionEvent: Signal;
	const hardwareChanged: Signal;
	const inputDeviceRunningChanged: Signal;
	const inputEvent: Signal;
	const keyPressEvent: Signal;
	const keyReleaseEvent: Signal;
	const mouseDoublePressEvent: Signal;
	const mouseMoveEvent: Signal;
	const mousePressEvent: Signal;
	const mouseReleaseEvent: Signal;
	const touchBeginEvent: Signal;
	const touchEndEvent: Signal;
	const touchUpdateEvent: Signal;
	const wheelEvent: Signal;
