...
-   [Sit On Someone](https://hifi.maki.cafe/client-scripts/sitOnSomeone/sitOnSomeone.js)
...
-   [Where Are My Friends](https://hifi.maki.cafe/client-scripts/whereAreMyFriends/whereAreMyFriends.js)
...
-   [Load Script If Named](https://hifi.maki.cafe/client-entity-scripts/loadScriptIfNamed.js)
-   [Open URL](https://hifi.maki.cafe/client-entity-scripts/openUrl.js)
...
-   [Zoned Invisible Web Player](https://hifi.maki.cafe/client-entity-scripts/zonedInvisibleWebPlayer.js)
-   [Zoned Playlist Sound Emitter](https://hifi.maki.cafe/client-entity-scripts/zonedPlaylistSoundEmitter.js)
-   [Zoned YouTube Player](https://hifi.maki.cafe/client-entity-scripts/zonedYoutubePlayer/zonedYoutubePlayer.js)
-   [Welcome Sign](https://hifi.maki.cafe/client-entity-scripts/welcomeSign/welcomeSign.js)

## server entity scripts

-   [Random Animation Player](https://hifi.maki.cafe/server-entity-scripts/randomAnimationPlayer.js)
...
-   [Force close Hifi](https://hifi.maki.cafe/batch-files/force-close-hifi.bat)
...
-   [Convert old flow.js to new .fst flow](https://hifi.maki.cafe/external-scripts/convertFlow.html)
-   [Music to atp:/ normalized](https://hifi.maki.cafe/external-scripts/musicToAtpNormalized.js)
...
-   [Feature Requests](https://hifi.maki.cafe/roadmap-mirror/feature-requests)
